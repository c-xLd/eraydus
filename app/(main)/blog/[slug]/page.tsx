    ...
    <>
      ...
      <article className="bg-background pb-32 pt-32 md:pb-44 md:pt-40">
        <div className="container mx-auto max-w-4xl px-6">
          ...
          {post.featured_image && <div className="mt-12 relative aspect-[16/9] w-full rounded-2xl overflow-hidden"><Image src={post.featured_image} alt={post.title} fill sizes="(max-width: 1024px) 100vw, 1024px" className="object-cover" /></div>}
