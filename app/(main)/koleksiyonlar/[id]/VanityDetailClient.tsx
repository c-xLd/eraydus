        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4">
              ...
              <a 
                href={`https://wa.me/905000000000?text=${encodeURIComponent(`Merhaba, ${product.name} banyo dolabı modeli hakkında bilgi almak ve sipariş vermek istiyorum.`)}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 border border-[#25D366] text-[#25D366] h-14 rounded-full font-medium tracking-wide flex items-center justify-center gap-2 hover:bg-[#25D366]/5 transition-colors"
              >
                Whatsapp'tan Ulaş
