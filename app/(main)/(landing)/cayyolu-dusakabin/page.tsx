...
export default function CayyoluDusakabinPage() {
  ...
  const serviceSchema = getServiceSchema({
    name: 'Çayyolu ve İncek Özel Ölçü Duşakabin Hizmeti',
    description: metadata.description || 'Çayyolu ve İncek bölgesinde ücretsiz keşif, özel ölçü duşakabin imalatı ve montaj hizmeti.',
    url: '/cayyolu-dusakabin',
  }, localGeoData)
  const breadcrumbs = [
    { name: 'Ana Sayfa', url: '/' },
